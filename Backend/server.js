...
// CORS configuration
app.use(cors({
  origin: ['http://localhost:5173', 'http://127.0.0.1:5173', 'http://localhost:3000', 'https://invoice-generator-one-rho.vercel.app'],
  credentials: true,
...
const server = app.listen(PORT, () => {
  ...
  console.log(`📁 Database: ${process.env.MONGODB_URI || 'mongodb://localhost:27017/invoices'}`);
});
